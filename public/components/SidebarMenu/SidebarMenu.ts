...
export const SECONDARY_MENU_ITEMS: MenuItem[] = [
    { topic_id: 1, key: 'Сервисы', icon: '/img/icons/services_icon.svg', text: 'Сервисы' },
    { topic_id: 2, key: 'Маркетинг', icon: '/img/icons/marketing_icon.svg', text: 'Маркетинг' },
    { topic_id: 3, key: 'Деньги', icon: '/img/icons/money_icon.svg', text: 'Деньги' },
    { topic_id: 4, key: 'Путешествия', icon: '/img/icons/travel_icon.svg', text: 'Путешествия' },
    { topic_id: 5, key: 'AI', icon: '/img/icons/AI_icon.svg', text: 'AI' },
    { topic_id: 6, key: 'Личный опыт', icon: '/img/icons/person-exp_icon.svg', text: 'Личный опыт' },
    { topic_id: 7, key: 'Инвестиции', icon: '/img/icons/invest_icon.svg', text: 'Инвестиции' },
    { topic_id: 8, key: 'Карьера', icon: '/img/icons/career_icon.svg', text: 'Карьера' },
    { topic_id: 9, key: 'Образование', icon: '/img/icons/edu_icon.svg', text: 'Образование' },
];
